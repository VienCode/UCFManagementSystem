...
if (empty($_POST["firstname"]) || empty($_POST["lastname"]) || empty($_POST["contact"]) || empty($_POST["age"]) || empty($_POST["user_address"]) || empty($_POST["email"]) || empty($_POST["pwd"]) || empty($_POST["confirm_pwd"])) {
    echo "<script>
...
if (!empty($_POST["cell_leader"])) {
    $sql = "INSERT INTO members 
            (firstname, middlename, lastname, suffix, contact, age, user_address, cell_leader, email, pwd_hash)
            VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
    ...
    $sql = "INSERT INTO non_members 
            (firstname, middlename, lastname, suffix, contact, age, user_address, email, pwd_hash)
            VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?)";
